// https://console.aws.amazon.com/lambda/home?region=us-east-1#/functions/postConnectLeadSTAGING
...
exports.handler = (event, context) => {
  ...
  if (firstName == '' || firstName == ' ' || firstName == undefined) {
	...
	const callerData = {
		...
		FirstName: firstName,
		LastName: lastName,
		Referrer: event["Details"]["ContactData"]["Attributes"]["propertyCallReferrer"] || 'Unknown',
