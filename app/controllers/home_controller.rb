class HomeController < ApplicationController
  ...
  def dashboard
    ...
    @my_leads = Lead.for_agent(current_user).in_progress.is_lead.includes(:source)
    @open_leads = current_user.available_leads(@current_property&.leads).includes(:property, :source)
