json.extract! lead, :id, :remoteid, :title, :first_name, :middle_name, :last_name, :company, :company_title, :referral, :state, :notes, :first_comm, :last_comm, :phone1, :phone2, :fax, :email, :created_at, :updated_at, :priority
json.preference do
