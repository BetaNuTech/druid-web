namespace :statistics do
  ...
  task :bootstrap => :environment do
    ...
    61.times{|i| Statistic.rollup_leadspeed(interval: :day, time_start: (i+1).days.ago.beginning_of_day)}

    puts "*** Rolling up Leadspeed by week for the past 2 months"
    9.times{|i| Statistic.rollup_leadspeed(interval: :week, time_start: (i+1).weeks.ago.beginning_of_week)}
