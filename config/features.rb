...
Flipflop.configure do
  ...
  feature :lead_automatic_dedupe, default: lead_automatic_dedupe_enabled, description: 'Automatically mark high confidence duplicates as disqualified as duplicate'
