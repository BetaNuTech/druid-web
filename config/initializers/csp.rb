SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
    ...
    connect_src: Rails.env.production? ? %w('self' https://capture.trackjs.com https://s3.amazonaws.com/druid-staging-activestorage https://s3.amazonaws.com/druid-prod-activestorage ws://www.blue-sky.app) : %w('self' http://localhost:3035 ws://localhost:3035 https://capture.trackjs.com https://s3.amazonaws.com/druid-staging-activestorage ws://localhost:3000),
