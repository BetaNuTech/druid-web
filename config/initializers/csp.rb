SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
    ...
    connect_src: Rails.env.production? ? %w('self' https://capture.trackjs.com https://apm.scoutapp.com https://s3.amazonaws.com/druid-prod-activestorage) : %w('self' http://localhost:3035 ws://localhost:3035 https://apm.scoutapp.com https://capture.trackjs.com https://s3.amazonaws.com/druid-staging-activestorage),
