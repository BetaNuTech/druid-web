...
RSpec.describe IncomingMessagesPropertyChannel, type: :channel do
  ...
  let(:user) { team1_agent1; team1_agent1.profile.switch_setting!(:lead_web_notifications, true); team1_agent1.switch_setting!(:message_web_notifications, true); team1_agent1.switch_setting!(:view_all_messages, true); team1_agent1 }
  let(:user2) { team1_agent2; team1_agent2.profile.switch_setting!(:lead_web_notifications, true); team1_agent2 }
